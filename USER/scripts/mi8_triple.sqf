...
private _mi8_3 = "RHS_Mi8MTV3_heavy_vvs" createVehicle [0,200,300];
createVehicleCrew _mi8_3;
_mi8_3 engineOn true;
[_mi8_3, call grad_autoinit_fnc_flightpath_mi8_3] spawn BIS_fnc_unitPlay;


[_mi8_1] call grad_autoinit_fnc_createCargo;
[_mi8_2] call grad_autoinit_fnc_createCargo;
[_mi8_3] call grad_autoinit_fnc_createCargo;